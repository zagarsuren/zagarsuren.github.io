          ...
          <div className="grid gap-6 sm:grid-cols-2 md:gap-12 lg:gap-24">
            ...
            <div className="relative space-y-4">
              <p className="text-white font-mono">
                👋 Hi, I’m Zagarsuren — an AI Specialist and with a strong foundation in statistics, data science, and machine learning. I specialize in building intelligent systems that combine data-driven insights with real-world impact.
              </p>
              
              <p className="text-white font-mono">
                I recently completed my Master of Artificial Intelligence at the University of Technology Sydney, where I developed advanced skills in data analytics, machine learning, and AI system development.
              </p>
              {/*<p className="text-white font-mono">
